...
namespace WeApiEntityFramework.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        {
            if (id != customers.DriverLicenceNumber)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<Customers>> PostCustomers(Customers customers)
        {
            ...
            {
                if (CustomersExists(customers.DriverLicenceNumber))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetCustomers", new { id = customers.DriverLicenceNumber }, customers);
        }
        ...
        {
            return _context.Customers.Any(e => e.DriverLicenceNumber == id);
        }
    }
}
